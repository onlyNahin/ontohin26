...
function App() {
  ...
  return (
    <Router>
      <Routes>
        <Route path="/" element={<Home darkMode={darkMode} toggleTheme={toggleTheme} aboutData={aboutData} historyData={historyData} footerData={footerData} heroData={heroData} events={events} galleryItems={galleryItems} onRegister={handleRegistrationSubmit} />} />
